...
class MudiExperience{
    ...
    createStyles(){
        ...
        link.href=`https://cdn.jsdelivr.net/gh/RodriguezJose92/stealthMasters@latest/index.css`; /* custom this path */
                    ...
                    <div id="containerQR" class="containerQRMudi" style="background-color:${this.color}">
                        ...
                        <div class="containerText">
                            ...
                            <div class="titleContainer">
                                ...
                                <p class="textInfoMudi">Aim the phone at the wall.</p>
                            </div>
